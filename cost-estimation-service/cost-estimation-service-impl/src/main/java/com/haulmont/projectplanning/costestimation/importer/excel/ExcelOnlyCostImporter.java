...
/**
 * Only one level hierarchy is supported. Does not support OVERLAY strategy
 */
@Order(20)
@Component
@Scope(SCOPE_PROTOTYPE)
@SuppressWarnings({"UnusedReturnValue", "unused"})
public class ExcelOnlyCostImporter extends AbstractTransactionalCostProjectImporter {

    private static Logger logger = LoggerFactory.getLogger(ExcelOnlyCostImporter.class);
    ...
    public ExcelOnlyCostImporter(Calculation calculation,
    ...
    private void defineMeasureBasedOnType(CostProjectItem costItem, String measureId, Cell cell) {
        ...
        if (cell.getCellType() == CellType.NUMERIC) {
            logger.trace("Define manual measure value: {}", cell.getNumericCellValue());
        ...
        if (cell.getCellType() == CellType.FORMULA) {
            logger.trace("Define auto measure value: {}", cell.getNumericCellValue());
